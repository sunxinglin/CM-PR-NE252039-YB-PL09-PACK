...
{
    /// <summary>
    /// AutoTightenMonitorView.xaml 的交互逻辑
    /// </summary>
    public partial class UpperCoverTightenMonitorView : UserControl, IViewFor<UpperCoverTightenMonitorViewModelBase>
    {
        public UpperCoverTightenMonitorView()
        {
            InitializeComponent();
        ...
        #region ViewModel
        public UpperCoverTightenMonitorViewModelBase ViewModel
        {
            get { return (UpperCoverTightenMonitorViewModelBase)GetValue(ViewModelProperty); }
            set { SetValue(ViewModelProperty, value); }
        }

        object IViewFor.ViewModel { get => this.ViewModel; set => this.ViewModel = (UpperCoverTightenMonitorViewModelBase)value; }

        public static readonly DependencyProperty ViewModelProperty =
            DependencyProperty.Register(nameof(ViewModel), typeof(UpperCoverTightenMonitorViewModelBase), typeof(UpperCoverTightenMonitorView), new PropertyMetadata(null));
        #endregion
    }
}
