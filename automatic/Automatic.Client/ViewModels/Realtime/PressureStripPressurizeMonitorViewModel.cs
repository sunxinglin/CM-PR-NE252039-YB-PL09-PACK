...
{
    public class PressureStripPressurizeMonitorViewModel : ReactiveObject
    {
        public PressureStripPressurizeMonitorViewModel()
        {
            #region 通用状态
            ...
            ScanContextSubject.Select(c => c.DevMsg.PressurizeComplete.CompleteTime).ToPropertyEx(this, x => x.CompleteTime, scheduler: RxApp.MainThreadScheduler);
            ...
            ScanContextSubject.Select(c => c.MstMsg.PressurizeComplete.ErrorCode).ToPropertyEx(this, x => x.ComplateErrorCode, scheduler: RxApp.MainThreadScheduler);

            ReshapeWrapSubject.Select(s => s.PressureValue).ToPropertyEx(this, x => x.PressureValues, scheduler: RxApp.MainThreadScheduler);
