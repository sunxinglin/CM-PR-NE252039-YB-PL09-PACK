...
{
    public class ShoulderGlueScanner : S7PlcScanner<DevMsg, MstMsg>
    {
        private readonly IMediator _mediator;

        public ShoulderGlueScanner(IMediator mediator, IServiceScopeFactory ssf, ILogger<S7PlcScanner<DevMsg, MstMsg>> logger, IOptionsMonitor<S7ScanOpt> scanOpts, S7PlcMgr plcMgr)
        ...
        public override string ScanName => PLCNames.肩部涂胶;
