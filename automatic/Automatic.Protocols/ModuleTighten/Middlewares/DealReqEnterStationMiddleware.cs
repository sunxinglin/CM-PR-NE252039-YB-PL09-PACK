...
namespace Automatic.Protocols.ModuleTighten.Middlewares
{
        ...
        HandlePlcRequestMiddlewareBase<DevMsg, MstMsg, DealReqEnterStationWraps, DealReqEnterStationOkWraps, DealReqEnterStationNgWraps>
    {
        ...
        public DealReqEnterStationMiddleware(ModuleTightenFlusher flusher, ILogger<DealReqEnterStationMiddleware> logger, IMediator mediator, CommonService commonService, IOptionsMonitor<ApiServerSetting> apiServerSetting) : base(flusher, logger, mediator)
        {
