...
namespace Automatic.Protocols.HeatingFilmPressurize.Middlewares.Common
{
    public class FlushPendingMiddleware : IWorkMiddleware<ScanContext>
    {
        ...
        private readonly HeatingFilmPressurizeFlusher _flusher;

        public FlushPendingMiddleware(ILogger<FlushPendingMiddleware> logger, HeatingFilmPressurizeFlusher flusher)
        {
            _logger = logger;
            _flusher = flusher;
        }
