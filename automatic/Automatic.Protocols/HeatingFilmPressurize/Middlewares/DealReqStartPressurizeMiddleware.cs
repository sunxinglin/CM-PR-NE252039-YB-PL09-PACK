...
{
    public class DealReqStartPressurizeMiddleware : HandlePlcRequestMiddlewareBase<DevMsg, MstMsg, DealReqStartPressurizeWraps, DealReqStartPressurizeOkWraps, DealReqStartPressurizeNgWraps>
    {
        private readonly CommonService _commonService;
        public readonly IOptionsMonitor<ApiServerSetting> _ApiServerSetting;
        private readonly bool _isEmptyLoop;

        public DealReqStartPressurizeMiddleware(HeatingFilmPressurizeFlusher flusher, ILogger<DealReqStartPressurizeMiddleware> logger,
            IMediator mediator, CommonService commonService, IOptionsMonitor<ApiServerSetting> apiServerSetting) : base(flusher, logger, mediator)
        {
