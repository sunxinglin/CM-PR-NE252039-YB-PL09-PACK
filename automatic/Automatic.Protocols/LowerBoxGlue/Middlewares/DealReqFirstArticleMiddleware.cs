...
namespace Automatic.Protocols.LowerBoxGlue.Middlewares
{
        ...
        : HandlePlcRequestMiddlewareBase<DevMsg, MstMsg, DealReqFirstArticleWraps, DealReqFirstArticleOkWraps, DealReqFirstArticleNgWraps>
    {
        ...
        public DealReqFirstArticleMiddleware(LowerBoxGlueFlusher flusher, ILogger<DealReqFirstArticleMiddleware> logger, IMediator mediator,
            AutoGlueService glueService, IOptionsMonitor<ApiServerSetting> apiServerSetting) : base(flusher, logger, mediator)
        {
