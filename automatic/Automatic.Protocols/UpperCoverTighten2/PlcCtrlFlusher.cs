...
{
    public class PlcFlusher : S7PlcFlusher<PlcScanner, DevMsg, MstMsg>
    {
        public PlcFlusher(IOptionsMonitor<S7ScanOpt> scanOptsMonitor, PlcScanner scanner) : base(scanOptsMonitor, scanner)
        {
        }

        protected override string PlcName => PLCNames.上盖拧紧2;
