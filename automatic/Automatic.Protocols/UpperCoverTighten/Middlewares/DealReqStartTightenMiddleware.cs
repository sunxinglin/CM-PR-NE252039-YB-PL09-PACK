...
namespace Automatic.Protocols.UpperCoverTighten.Middlewares
{
        ...
        HandlePlcRequestMiddlewareBase<DevMsg, MstMsg, DealReqStartTightenWraps, DealReqStartBoltOkWraps, DealReqStartBoltNgWraps>
    {
        ...
        public DealReqStartTightenMiddleware(UpperCoverTightenFlusher flusher, ILogger<DealReqStartTightenMiddleware> logger, IMediator mediator, CommonService commonService, IOptionsMonitor<ApiServerSetting> apiServerSetting) : base(flusher, logger, mediator)
        {
