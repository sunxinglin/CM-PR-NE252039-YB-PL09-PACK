...
namespace Automatic.Protocols.UpperCoverTighten.Middlewares
{
        ...
        HandlePlcRequestMiddlewareBase<DevMsg, MstMsg, DealReqEnterStationWraps, DealReqEnterStationOkWraps, DealReqEnterStationNgWraps>
    {
        ...
        public DealReqEnterStationMiddleware(UpperCoverTightenFlusher flusher, ILogger<DealReqEnterStationMiddleware> logger, IMediator mediator, CommonService commonService, IOptionsMonitor<ApiServerSetting> apiServerSetting) : base(flusher, logger, mediator)
        {
        ...
        public override string PlcName => PLCNames.上盖拧紧;

        public override string ProcName => PLCNames.上盖拧紧;
