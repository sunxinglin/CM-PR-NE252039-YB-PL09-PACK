...
using Automatic.Protocols.UpperCoverTighten.Models.Datas;
...
namespace Automatic.Protocols.UpperCoverTighten.Middlewares
{
        ...
        HandlePlcRequestMiddlewareBase<DevMsg, MstMsg, DealReqTightenCompleteWraps, DealReqTightenCompleteOkWraps, DealReqTightenCompleteNgWraps>
    {
        ...
        public DealReqTightenCompleteMiddleware(UpperCoverTightenFlusher flusher, ILogger<DealReqTightenCompleteMiddleware> logger,
