...
//{
//    public class Proc_PressureStripInfosService
//    {
//        private readonly AsZeroDbContext _dbContext;

//        public Proc_PressureStripInfosService(AsZeroDbContext dbContext)
//        {
...
//        /// <returns></returns>
//        public async Task<Response<List<Proc_PressureStripInfo>>> GetPageList(PressureStripInfosDto dto)
//        {
//            var result = new Response<List<Proc_PressureStripInfo>>();
//            try
//            {
//                var query = _dbContext.Proc_PressureStripInfos.OrderByDescending(o => o.CreateTime).Where(e => e.IsDeleted == false);
...
//        /// <returns></returns>
//        public async Task<(Boolean, string)> ExportGluingInfo(PressureStripInfosDto dto)
//        {
//            //文件路径
//            string filepath = Directory.GetCurrentDirectory() + @"\压条加压数据导出.xls";
//            //判断文件路径是否存在 存在就删除
...
//                excelPackage = ExcelToEntity.ListToExcek<GulingInfoToExcel>(excelPackage, "压条加压数据导出", 2, gulingExcellist);
...
//        /// <param name="dto"></param>
//        /// <returns></returns>
//        public async Task<Response<List<Proc_PressureStripInfo>>> GetPageListExport(PressureStripInfosDto dto)
//        {
//            var result = new Response<List<Proc_PressureStripInfo>>();
//            try
//            {
