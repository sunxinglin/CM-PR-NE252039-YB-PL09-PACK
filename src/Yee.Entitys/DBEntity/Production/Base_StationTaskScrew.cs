...
public class Base_StationTaskScrew : CommonData, INotifyPropertyChanged
{
    ...
    public string? CurScrewValueStr
    {
        ...
        set
        {
            ...
            this.PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(CurScrewValueStr)));
        }
    }
    [NotMapped]
    ...
    public string? CurFinalAngleStr
    {
        ...
        set
        {
            ...
            this.PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(CurFinalAngleStr)));
        }
    }
    [NotMapped]
    ...
    public string? CurAngle_MaxStr
    {
        ...
        set
        {
            ...
            this.PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(CurAngle_MaxStr)));
        }
    }
    [NotMapped]
    ...
    public string? CurAngle_MinStr
    {
        ...
        set
        {
            ...
            this.PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(CurAngle_MinStr)));
        }
    }
    ...
    public string? CurScrewState
    {
        ...
        set
        {
            ...
            this.PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(CurScrewState)));
        }
    }
    ...
    public int CurNo
    {
        ...
        {
            _CurNo = value;
            this.PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(CurNo)));
        }
    }

    [NotMapped]
    private List<ScrewResult> _ScrewResultList = new();
    ...
    public List<ScrewResult> ScrewResultList
    {
        ...
        set
        {
            ...
            this.PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(ScrewResultList)));
        }
    }
    ...
    public bool ShowPop
    {
        ...
        {
            _ShowPop = value;
            this.PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(ShowPop)));
        }
    }

    [NotMapped]
    public int CurentScrewNo { get; set; } = 1;
    [NotMapped]
    ...
    [NotMapped]
    private List<int> _NeedReWordSource  = new();
    [NotMapped]
    public List<int> NeedReWordSource
    {
        ...
        set
        {
            this.PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(NeedReWordSource)));
    ...
    public int ReWorkScrewNum
    {
        ...
        set
        {
            this.PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(ReWorkScrewNum)));
