        ...
        public async Task InvokeAsync(ScanContext context, WorkDelegate<ScanContext> next)
        {
            ...
            if (tightenCompleteReq && !tightenCompleteAck)
            {
                ...
                var notification = new StationPLCTightenResultNotification()
                {
                    ...
                    TightenResult = context.DevMsg.TightenComplete.TightenResult.TighteningResultFlag.HasFlag(TightenFlag.Tightening_OK),
                    ...
                    ToruqeRateMax = context.DevMsg.TightenComplete.TightenResult.TorqueRate_Max,
