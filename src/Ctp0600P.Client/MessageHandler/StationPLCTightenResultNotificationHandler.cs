...
public class StationPLCTightenResultNotificationHandler : INotificationHandler<StationPLCTightenResultNotification>
{
    ...
    public Task Handle(StationPLCTightenResultNotification notification, CancellationToken cancellationToken)
    {
        var request = new BoltGunRequest
        {
            ...
            TorqueRate_Max = Convert.ToDecimal(notification.TorqueRateMax),
