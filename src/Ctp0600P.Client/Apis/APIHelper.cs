...
namespace Ctp0600P.Client.Apis
{
    public class APIHelper : IAPIHelper
    {
        ...
        private readonly ITraceApi traceApi;
        ...
        {
            var resp = await traceApi.Check_CreateAccountCardAsync(accountCardValue);
        ...
        {
            var resp = await traceApi.GetUploadCATLData(App.PackBarCode, App._StepStationSetting.Step.Id, App._StepStationSetting.Station.Id);
            return resp.IsSuccessStatusCode ? resp.Content : new Response<UploadCATLData> { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }

        public async void Record_CheckPower_Log(string password, string modleName, List<Alarm> alarms)
        {
            var checkDTO = new RecordCheckPowerDTO
            {
                ...
                Account = password,
                ModuleName = modleName,
                Alarms = alarms
            };

            _logger.LogDebug($"记录校验权限日志请求体：{JsonSerializer.Serialize(checkDTO)}");

            await traceApi.Record_CheckPower_Log(checkDTO);
        }
        ...
        {
            var resp = await traceApi.ValidateUser(account, password);
            return resp.IsSuccessStatusCode ? resp.Content : new Response<User> { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }
        ...
        {
            var resp = await traceApi.CheckuserClaims(account, password);
        ...
        {
            var resp = await traceApi.LoadStationProResourceConfig(App._StepStationSetting.StationCode, (int)type);
        ...
        public async Task<Response<List<Base_ProResource>>> SaveStationEquipmentConifgData(List<Base_ProResource> stationScanCodeGunList, ProResourceTypeEnum resourceType)
        {
            var resp = await traceApi.SaveStationEquipmentConifgData(stationScanCodeGunList, resourceType, App._StepStationSetting.StationCode, App.PowerUser);
            return resp.IsSuccessStatusCode ? resp.Content : new Response<List<Base_ProResource>> { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }
        ...
        public async Task<Response> SaveCheckTimeOutData(Base_StationTaskCheckTimeOut proc, int taskId)
        {
            ...
            var resp = await traceApi.SaveStationTaskCheckTimeOut(postData);
        ...
        public async Task<Response> SaveStewingTimeMessage(Base_StationTaskStewingTime proc)
        {
            ...
            var resp = await traceApi.SaveStationTaskStewingTime(postData);
            return resp.IsSuccessStatusCode ? resp.Content : new Response { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }
        ...
        public async Task<Response> SaveScanCodeDetailData(Base_StationTaskBom hasGoods, int taskId)
        {
            ...
            hasGoods.CreateTime = DateTime.Now;
            ...
            var resp = await traceApi.Save_StationTaskBom(postData);
            return resp.IsSuccessStatusCode ? resp.Content : new Response { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };

        }
        public async Task<Response> CheckBomUsed(Base_StationTaskBom hasGoods)
        {
            var resp = await traceApi.CheckBomUsed(App._StepStationSetting.Step.Id, hasGoods.TracingType, hasGoods.TracingType == TracingTypeEnum.批追 ? hasGoods.UniBarCode : hasGoods.GoodsOuterCode);
            return resp.IsSuccessStatusCode ? resp.Content : new Response { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        ...
        public async Task<Response> SaveAnyLoadData(Base_StationTaskAnyLoad taskAnyLoad, int taskId)
        {
            ...
            var resp = await traceApi.Save_StationAnyLoad(postData);
            return resp.IsSuccessStatusCode ? resp.Content : new Response { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }
        ...
        public async Task<Response> SaveAccountCardData(Base_StationTaskScanAccountCard taskScanAccountCard, int taskId)
        {
            ...
            var resp = await traceApi.Save_AccountCardData(postData);
            return resp.IsSuccessStatusCode ? resp.Content : new Response { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }
        ...
        public async Task<Response> Save_StationUserScan(Base_StationTaskUserInput taskUserScan, int taskId)
        {
            ...
            taskUserScan.CreateTime = DateTime.Now;
            ...
            var resp = await traceApi.Save_StationUserScan(postData);
            return resp.IsSuccessStatusCode ? resp.Content : new Response { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }
        ...
        public async Task<Response> Save_StationScanCollect(Base_StationTaskScanCollect taskScanCollect, int taskId)
        {
            ...
            var resp = await traceApi.Save_StationScanCollect(postData);
            return resp.IsSuccessStatusCode ? resp.Content : new Response { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }
        ...
        public async Task<Response> SetStationCurTaskFinish(StationTaskDTO dto, int mainId)
        {
            ...
            var resp = await traceApi.SetStationCurTaskFinish(dto, mainId);
            return resp.IsSuccessStatusCode ? resp.Content : new Response { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }
        ...
        {
            if (App.ActivePage != null && App.ActivePage.GetType() == typeof(LetGoPage) && !App.IsDealingRunAGV && !string.IsNullOrEmpty(App.PackBarCode) && App._RealtimePage._VM.StationTaskDataList.Count > 0 && App._RealtimePage._VM.StationTaskLeftTagDataList.Count > 0)
            {
                dto.AGVCode = App.AGVCode;
                dto.PackCode = App.PackBarCode;
                ...
                var resp = await traceApi.SetStationCurTaskRunAGV(dto, App.HisTaskData2.MainId);
                return resp.IsSuccessStatusCode ? resp.Content : new Response { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
            }
            else
                return new Response();
        ...
        public async Task<Response> SetReWork(List<ReworkListDTO> reworkLists)
        {
            ...
            var resp = await traceApi.SetReWork(reworkLists);
            return resp.IsSuccessStatusCode ? resp.Content : new Response { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }
        ...
        public async Task<Response> SaveScrewData(Base_StationTaskScrew screw, int taskId)
        {
            ...
            var resp = await traceApi.SaveScrewData(postData);
            return resp.IsSuccessStatusCode ? resp.Content : new Response { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }
        ...
        public async Task<Response> SetScrewTaskFinish(Base_StationTaskScrew screw)
        {
            ...
            var resp = await traceApi.SetScrewTaskFinish(screw, App.HisTaskData2.MainId);
            return resp.IsSuccessStatusCode ? resp.Content : new Response { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }
        #endregion
        ...
        {
            var resp = await traceApi.LoadStationTaskHistoryData(id, scanCode);
        ...
        {
            var resp = await traceApi.GetGluingStartTime(packPN);
        ...
        {
            var resp = await traceApi.GetModuleInBoxEndTime(packPN, stepCode);
        ...
        {
            var resp = await traceApi.GetStepTaskEndTime(packPN, stepCode);
            return resp.IsSuccessStatusCode ? resp.Content : new Response<DateTime> { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }
        ...
        {
            var resp = await traceApi.GetBoltGunEndTime(packPN, stepCode);
            return resp.IsSuccessStatusCode ? resp.Content : new Response<DateTime> { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }
        #endregion
        ...
        public async Task<Response> DealCatlMES_InStation(string packPN, List<StationTaskDTO> stationTaskList)
        {
            ...
            var resp = await traceApi.DealCatlMES_InStation(dto);
            return resp.IsSuccessStatusCode ? resp.Content : new Response { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }
        ...
        {
            var resp = await traceApi.LoadAutoBoltData_Prev(App._StepStationSetting.Step.Id, App.PackBarCode);
            return resp.IsSuccessStatusCode ? resp.Content.Result : null!;
        }
        ...
        {
            var resp = await traceApi.LoadBoltData(App._StepStationSetting.Step.Id, stationtaskid, App.PackBarCode);
            return resp.IsSuccessStatusCode ? resp.Content.Result : null!;
        }
        ...
        {
            var resp = await traceApi.LoadStationCurrentAGV(App._StepStationSetting.StationCode);
        ...
        {
            var resp = await traceApi.CheckPack_AGV_Task_Record(productId, stepId, App._StepStationSetting.Station.Code, App.AGVCode, scanCodeContext);
        ...
        /// <param name="dTO"></param>
        /// <returns></returns>
        public async Task<Response<string>> BingAGVPack(BingAgvDTO dTO)
        {
            var resp = await traceApi.BingAgv(dTO);
        ...
        {
            var resp = await traceApi.PullStepBack(agvNo, App._StepStationSetting.Step.Code, packBarCode, outCode);
            return resp.IsSuccessStatusCode ? resp.Content : new Response { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }


        public async Task<Response<string>> BingAGVPAck_SBox(BingAgvDTO dto)
        {
            var resp = await traceApi.BingAgv_SBox(dto);
            return resp.IsSuccessStatusCode ? resp.Content : new Response<string> { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }
        ...
        {
            var resp = await traceApi.RunAGV(agvCode, releaseType);
            return resp.IsSuccessStatusCode ? resp.Content : new Response { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }

        public async Task<Response> RunAGVByStepCode(string stepCode, int releaseType)
        {
            var resp = await traceApi.RunAGVByStepCode(stepCode, releaseType);
            return resp.IsSuccessStatusCode ? resp.Content : new Response { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }
        ...
        public async Task<List<Alarm>> OccurAlarm(AlarmDTO dto)
        {
            ...
            var resp = await traceApi.Occur(dto);
            return resp.IsSuccessStatusCode ? resp.Content.Result : null;
        }
        ...
        public async Task<List<Alarm>> ClearALLAlarm(List<AlarmDTO> dtos)
        {
            ...
            var resp = await traceApi.ClearALL(dtos);
            return resp.IsSuccessStatusCode ? resp.Content.Result : null;
        ...
        {
            var resp = await traceApi.CheckPower(account, modlename);
        ...
        {
            var resp = await traceApi.OfflineAdd(dto);
        ...
        {
            var resp = await traceApi.GetOutScanRange(StationTaskId.ToString());
        ...
        {
            var resp = await traceApi.GetScanCollectInfo(App._StepStationSetting.Step.Id, App.PackBarCode, ScanData);
            return resp.IsSuccessStatusCode ? resp.Content : new Response<bool> { Code = Convert.ToInt32(resp.Error.StatusCode), Message = resp.Error.Message };
        }
        ...
        {
            var resp = await traceApi.LoadStepPackTaskMainData(stationCode, searchBeginTime.ToString("yyyy-MM-dd HH:mm:ss"), searchEndTime.ToString("yyyy-MM-dd HH:mm:ss"));
            return resp.IsSuccessStatusCode ? resp.Content.Result : null!;
        }

        public async Task<StepStationDTO> LoadStepStationData(string packCode, int productId)
        {
            var resp = await traceApi.LoadStepStationData(packCode, productId.ToString(), App._StepStationSetting.StationCode);
            return resp.IsSuccessStatusCode ? resp.Content.Result : null!;
        }
        ...
        {
            var resp = await traceApi.GetRecordTime(packCode, TimeFlag);
        ...
        {
            var resp = await traceApi.SaveRecordTime(dto);
        ...
        public async Task<FSharpResult<(string, int), string>> GetCurrentStationAndLevel(string stationFlag, string packCode)
        {
            ...
            var resp = await traceApi.GetCurrentStationAndLevel(stationFlag, packCode);
        ...
        {
            var resp = await traceApi.LoadFormula(stationCode, ProductPn);
        ...
        public async Task<FSharpResult<StationTaskHistoryDTO, string>> CreateOrLoadTraceInfo(string packCode, string stationCode, string productCode)
        {
            ...
            var resp = await traceApi.CreateOrLoadTraceInfo(packCode, stationCode, productCode);
            if (resp.IsSuccessStatusCode)
            {
                if (resp.Content.Code != 200)
                {
        ...
        public async Task<FSharpResult<bool, string>> CheckVectorBindAndFlowOrder(string packCode, int vectorCode, string stationCode, string VectorStation, string productPn, string packOutCode)
        {
            ...
            var resp = await traceApi.CheckVectorBindAndFlowOrder(packCode, vectorCode, stationCode, VectorStation, productPn, packOutCode);
            if (resp.IsSuccessStatusCode)
            {
                if (resp.Content.Code != 200)
                {
        ...
        public async Task<FSharpResult<bool, string>> CheckFlowOrder(string packCode, string stationCode, string productPn)
        {
            ...
            var resp = await traceApi.CheckFlowOrder(packCode, stationCode, productPn);
            if (resp.IsSuccessStatusCode)
            {
                if (resp.Content.Code != 200)
                {
        ...
        {
            var resp = await traceApi.LoadAutoTightenData(packCode, AutoTightenType, ScrewNum);
        ...
        public async Task<List<ReWorkData>> LoadReworkList(LoadReworkDataDto dto)
        {
            try
            {
                var result = await traceApi.LoadReworkList(dto);
                if (result.Code != 200)
                {
            ...
            {
                await mediator.Publish(new AlarmSYSNotification() { Code = AlarmCode.系统运行错误, Name = AlarmCode.系统运行错误.ToString(), Module = AlarmModule.DESOUTTER_MODULE, Description = $"接口调用异常：{ex.Message}" });
                return null;
            }
        }
        ...
        public async Task<Response> MakeRework(List<WorkRecord> workRecords)
        {
            ...
            try
            {
                result = await traceApi.MakeRework(workRecords);
            }
            catch (Exception ex)
            {
                await mediator.Publish(new AlarmSYSNotification() { Code = AlarmCode.系统运行错误, Name = AlarmCode.系统运行错误.ToString(), Module = AlarmModule.DESOUTTER_MODULE, Description = $"接口调用异常：{ex.Message}" });
        ...
        public async Task<Response> SetRecordWorking(int recordId)
        {
            ...
            try
            {
                result = await traceApi.SetRecordWorking(recordId);
            }
            catch (Exception ex)
            {
                await mediator.Publish(new AlarmSYSNotification() { Code = AlarmCode.系统运行错误, Name = AlarmCode.系统运行错误.ToString(), Module = AlarmModule.DESOUTTER_MODULE, Description = $"接口调用异常：{ex.Message}" });
        ...
        public async Task<Response<UploadCATLData>> GetUploadDataAgain(string packCode, string stationCode)
        {
            ...
            try
            {
                result = await traceApi.UploadDataAgain(packCode, stationCode);
            }
            catch (Exception ex)
            {
                await mediator.Publish(new AlarmSYSNotification() { Code = AlarmCode.系统运行错误, Name = AlarmCode.系统运行错误.ToString(), Module = AlarmModule.DESOUTTER_MODULE, Description = $"接口调用异常：{ex.Message}" });
        ...
        public async Task<Response<string>> GetProductPnFormDb(string packCode)
        {
            ...
            try
            {
                result = await traceApi.GetProductPnFormDb(packCode);
            }
            catch (Exception ex)
            {
                await mediator.Publish(new AlarmSYSNotification() { Code = AlarmCode.系统运行错误, Name = AlarmCode.系统运行错误.ToString(), Module = AlarmModule.DESOUTTER_MODULE, Description = $"接口调用异常：{ex.Message}" });
        ...
        {
            var resp = await traceApi.SaveScrewNGResetRecord(dto);
            return resp.IsSuccessStatusCode ? resp.Content : new Response() { Code = 500, Message = resp.Error.Message };
        }
    }
}
