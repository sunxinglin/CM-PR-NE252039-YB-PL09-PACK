...
namespace Ctp0600P.Client.Command.NoticeHelp;
...
public partial class NotificationWindow : Window
{
    ...
    private void NotificationWindow_Loaded(object sender, RoutedEventArgs e)
    {
        ...
        if (data != null)
        {
            ...
            tbTitle.Background = data.Background;
        }
        ...
        {
            self.UpdateLayout();
            //SystemSounds.Beep.Play();//播放提示声

            double right = SystemParameters.WorkArea.Width; //工作区最右边的值

            self.Top = self.TopFrom - self.Height;
            DoubleAnimation animation = new DoubleAnimation();
            animation.Duration =
                new Duration(TimeSpan.FromMilliseconds(500)); //NotifyTimeSpan是自己定义的一个int型变量，用来设置动画的持续时间
    ...
    public void dd()
    {
        ...
        //    RoutedEventArgs e2 = new RoutedEventArgs(MessageCard.CloseEvent, messageCard);
        //    messageCard.RaiseEvent(e2);
        //};
        //messageCard.BeginStoryboard(storyboard);
    }
