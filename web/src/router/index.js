...
export var constantRouterMap = [
  ...
  { path: '/another', component: () => import('@/views/login/another'), meta: { sortNo: 0 }, hidden: true },
  ...
  },
  {
    ...
    children: [{
      ...
      name: 'stationtask',
      hidden: true,
      meta: { title: '配方详情', icon: 'guide', sortNo: 0 },
      component: () => import('@/views/process/stationtask/index')
    }
    ,{
      path: '/Process/station/Index',
      name: 'station',
      hidden: true,
      meta: { title: '工位', icon: 'guide', sortNo: 0 },
      component: () => import('@/views/process/station/index')
    },{
      path: '/taskDetails',
      name: 'taskDetails',
      hidden: true,
      meta: { title: '工位扫码详情', icon: 'guide', sortNo: 0 },
      component: () => import('@/views/statusquery/taskDetails')
    }
  ]
  }
