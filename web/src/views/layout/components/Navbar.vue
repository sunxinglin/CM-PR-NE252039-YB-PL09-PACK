<template>
  <el-menu class="navbar" mode="horizontal">
		<div class="logo">
			<img class="user-avatar" :src="logo">CATL
		</div>
    ...
    <el-dropdown class="avatar-container" @command="handleCommand" trigger="click">
      ...
      <el-dropdown-menu class="user-dropdown" slot="dropdown">
        ...
        <el-dropdown-item>
					<span>夜间模式 <el-switch :active-value="1" :inactive-value="0" style="margin-left: 5px;" v-model="theme" /></span>
				</el-dropdown-item>
