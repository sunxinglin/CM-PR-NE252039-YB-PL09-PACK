  ...
  <div class="app-container">
    <el-col :span="24">
      <el-card shadow="never" class="boby-small" style="height: 100%">
        ...
        <div>
          <el-table
            :data="tasksDetailList"
            ref="dpTable"
            row-key="id"
            v-loading="tasksDetailLoading"
            border
            fit
            stripe
          ...
          >
            ...
            >
            <template slot-scope="scope" >
                  <el-button size="mini" @click="SetHasUpTask(scope.row,true)" v-show="scope.row.hasUpMesDone == false"  type="danger"
                  >未上传</el-button>
                  <el-button size="mini" @click="SetHasUpTask(scope.row,false)" v-show="scope.row.hasUpMesDone == true"  type="success"
                  >已上传</el-button>
            </template></el-table-column>
