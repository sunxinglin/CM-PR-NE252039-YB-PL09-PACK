  ...
  <div class="flex-column">
    ...
    <div class="app-container flex-item">
      ...
      <el-dialog class="dialog-mini user-dialog" v-el-drag-dialog :title="'分配用户'"
        ...
        <selectUsersCom ref="selectUser" v-if="roleUsers.dialogUserResource" :orgId="multipleSelection[0].id"
          :hiddenFooter="true" :loginKey="'loginUser'" :selectUsers.sync="GetselectUsers_Sync">
        </selectUsersCom>
...
export default {
  ...
  computed: {
    ...
    GetselectUsers_Sync() {
      return this.roleUsers.rowIndex > -1 && this.roleUsers.list[this.roleUsers.rowIndex];
    },
    mechOrgsTree() {
      const arr = [{
        id: '',
