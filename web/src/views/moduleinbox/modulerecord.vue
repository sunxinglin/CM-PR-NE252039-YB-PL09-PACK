    ...
    <div>
                    ...
                    <el-row :gutter="2">
                        <el-col :span="21">
                            ...
                            <el-input prefix-icon="el-icon-search" size="small" style="width: 200px;height: 20px;"
                                class="filter-item" :placeholder="'pack码/Bolck码'" v-model="query.PackPN">
                            </el-input>
                            ...
                            <el-button type="primary" icon="el-icon-plus" size="small" @click="getlist">
                                查询
                            </el-button>
        ...
        <div class="app-container">
            <el-table ref="detaillist" :data="detetaillist" v-loading="ListLoading" row-key="id" style="width: 100%"
                ...
                <el-table-column label="Block码" prop="blockCode" align="center" />
...
import * as moduleInBoxRecordAPI from "@/api/moduleInBoxRecord";
export default {
    components: {
        Sticky,
        permissionBtn,
    ...
    methods: {
        getlist() {
            ...
            moduleInBoxRecordAPI.Load(this.query).then((response) => {
        ...
        ModelExpornt() {
            moduleInBoxRecordAPI.modelExpornt(this.query).then((request) => {
                this.$notify({
                    title: "提示",
                    message: "数据整理完毕,正在下载",
                    type: "success",
                ...
                var fileName = "Block入箱记录详情数据导出.xlsx";
