    ...
    <div class="login-container" @click="pwdFocus">
        <div class="content">
            ...
            <el-tabs tabPosition="left" class="login-tabs">
                ...
                <label style="position: fixed; height: 70px; width: 450px; z-index: 1; background: #EBEBEA; padding-top: 25px; font-size: 60px; " @click="pwdFocus">请刷卡登录</label>
                <el-form autoComplete="on" :model="loginpaycard" class="login-form" @submit.native.prevent
                         label-position="left">

                    <el-form-item>
                        <el-input type="password" autoComplete="on" id="txtPWD" autofocus="true" v-model="loginpaycard.username"  />
                    </el-form-item>
                </el-form>
