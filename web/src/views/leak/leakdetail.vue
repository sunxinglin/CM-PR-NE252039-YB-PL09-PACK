    ...
    <div>
        ...
        <div class="app-container">
            <el-table ref="detaillist" :data="detetaillist" v-loading="ListLoading" row-key="id" style="width: 100%"
                ...
                <el-table-column label="任务名称" prop="paramName" align="center" />
                <el-table-column label="上传代码" prop="uploadCode" align="center" />
                <el-table-column label="任务数据" prop="paramValue" align="center" />
...
<script>
    ...
    import * as gluedetail from "@/api/leakdetail";
    export default {
        components: {
            Sticky,
            permissionBtn,
