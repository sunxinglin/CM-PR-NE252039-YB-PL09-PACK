            ...
            <el-table ref="detaillist" :data="detetaillist" v-loading="ListLoading" row-key="id" style="width: 100%"
                ...
                <el-table-column label="操作" prop="createTime" align="center">
                    <template slot-scope="scope">
                        <el-button type="primary" size="mini" @click="ViewTaskDetails(scope.row)">详情</el-button>
                    </template>
                </el-table-column>
            </el-table>
...
import * as gluedetail from "@/api/pressurestrip";
    ...
    methods: {
        ...
        upgluedata() {
            ...
            automicstationdataupcatlagain
                .upCatlAgain({ PackPN: this.query.PackPN, Code: "OP260" })
                .then((response) => {
        ...
        ViewTaskDetails(row) {
            this.detailDatas = row.pressureDatas;
