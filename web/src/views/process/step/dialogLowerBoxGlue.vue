    ...
    <div class="app-container">
      <el-col :span="24">
        <el-card shadow="never" class="boby-small" style="height: 100%">
          ...
          <div>
            <el-table :data="glueData" ref="dpTable" row-key="id" @current-change="handleSelectiondpChange" border fit
    ...
    <el-dialog v-el-drag-dialog class="dialog-mini" width="600px" :title="textMap[dialogStatus]"
      ...
      <div>
        <el-form :rules="glueRules" ref="dpForm" :model="glueTemp" label-position="right" label-width="100px">
          ...
          <el-form-item size="small" :label="'最小值'" prop="minValue">
            <el-input v-model="glueTemp.minValue" ></el-input>
          </el-form-item>

          <el-form-item size="small" :label="'最大值'" prop="maxValue">
...
<script>
import * as stationTaskAutoGlue from "@/api/stationTaskLowerBoxGlue.js";
