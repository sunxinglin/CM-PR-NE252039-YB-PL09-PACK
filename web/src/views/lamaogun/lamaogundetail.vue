    ...
    <div>
        ...
        <div class="app-container">
            <el-table ref="detaillist" :data="detetaillist" v-loading="ListLoading" row-key="id" style="width: 100%"
                ...
                <el-table-column label="序号" prop="orderNo" align="center" />
                <el-table-column label="拉力" prop="maxPullPower" align="center" />
                <el-table-column label="行程" prop="maxDistance" align="center" />
                <el-table-column label="拉力上传代码" prop="uploadCode_LL" align="center" />
                <el-table-column label="行程上传代码" prop="uploadCode_XC" align="center" />
...
<script>
    ...
    import * as lamaogundetail from "@/api/lamaogundetail";
    export default {
        components: {
            Sticky,
            permissionBtn,
        ...
        methods: {
            getlist() {
                ...
                lamaogundetail.Load(this.query).then((response) => {
