...
using CatlMesBase;
using MachineClose.MachineClose;
using System.Net;
using System.Configuration;

namespace MachineClose
{
    public class MesInvoke : MesInvokeBase
    {
        ...
        public override List<object> GetResult(List<object> objs)
        {
            ...
            MachineCloseServiceService webservice = new MachineCloseServiceService();
            ...
            machineCloseRequest Requst = new machineCloseRequest();
            Requst.site = model.SiteField;
            Requst.resrce = model.ResourceField;

            machineCloseService Requst1 = new machineCloseService();
            ...
            try
            {
                ...
                machineCloseServiceResponse response = webservice.machineCloseService(Requst1);
