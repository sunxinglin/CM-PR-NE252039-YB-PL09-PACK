...
namespace miReleaseSfcWithActivity
{
    class MesDataModel:MesModel
    {
        ...
        public override void ReadConfig()
        {
            ...
            value = IniFileHelper.ReadValue(SectionName, "ReleaseSfcWithActivityColumnOrRowFirstSpecified", FileName);
            ...
            {
                ReleaseSfcWithActivityColumnOrRowFirstField = columnOrRow.COLUMN_FIRST;
            }

            value = IniFileHelper.ReadValue(SectionName, "ReleaseSfcWithActivityModeProcessSFC", FileName);
            ...
            {
                ReleaseSfcWithActivityModeProcessSFCField = modeProcessSFC.MODE_NONE;
            }
        ...
        public columnOrRow ReleaseSfcWithActivityColumnOrRowFirstField
        {
            get
            {
        ...
        public modeProcessSFC ReleaseSfcWithActivityModeProcessSFCField
        {
            get
            {
